...
class SaigaLLMSkill:
    ...
    def generate_smm_post(
        ...
        if "кто так" in topic_lower or "о нас" in topic_lower or "знакомств" in topic_lower or "манифест" in topic_lower:
            ...
            body = (
                ...
                f"⚡ <b>4. Мультимедиа-продакшн</b> — генерация коммерческих фото-креативов и UltraHD видео для Shorts и Reels.\n\n"
    ...
    def self_heal_text(self, text: str, feedback: str) -> str:
        ...
        healed_post = (
            ...
            "• Создание UltraHD видео и фото-креативов без рутины и задержек\n\n"
