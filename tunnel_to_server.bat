@echo off
chcp 65001 > nul
title UCust Remote Tunnel (vm-8720.user-project-3970.cloud.intcld.ru / 194.67.95.119)

echo ======================================================================
echo 🌐 UCUST REMOTE SERVER TUNNEL (SSH PORT FORWARDING)
echo    Сервер: vm-8720.user-project-3970.cloud.intcld.ru (194.67.95.119)
echo ======================================================================
echo.
...
echo.
echo Введите пароль от root@vm-8720.user-project-3970.cloud.intcld.ru при запросе.
