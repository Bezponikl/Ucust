        ...
        if self._is_loaded and self._llm and os.getenv("DISABLE_LOCAL_LLM", "").lower() not in ["1", "true", "yes"]:
            try:
                ...
                system_instruction = (
                    ...
                    f"3. ЗАПРЕТ НА НЕЙРО-ШТАМПЫ И КЛИШЕ: Категорически запрещены фразы «В мире, где...», «Цифры говорят сами за себя», «Практика — лучший учитель», «крушить барьеры», «встречайте», «пушка/бомба», «не просто X, а Y».\n"
