...
class SaigaLLMSkill:
    ...
    def generate_smm_post(
        ...
        if "кто так" in topic_lower or "о нас" in topic_lower or "знакомств" in topic_lower or "манифест" in topic_lower:
            ...
            body = (
                ...
                f"⚡ <b>4. Мультимедиа-продакшн</b> — генерация студийных фото-креативов и реалистичных изображений под ключ.\n\n"
    ...
    def self_heal_text(self, text: str, feedback: str) -> str:
        ...
        healed_post = (
            ...
            "• Создание студийных фото-креативов и продающих визуалов без рутины и задержек\n\n"
