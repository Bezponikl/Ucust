...
export default function FinalCta() {
  ...
  return (
    <section className="px-4 pb-12 pt-4 sm:px-6 sm:pb-16 sm:pt-6 lg:pb-20">
      <Reveal className="relative mx-auto max-w-(--container-page) overflow-hidden rounded-[28px] bg-gradient-to-br from-hero-from via-hero-via to-hero-to px-6 py-16 text-center shadow-soft sm:rounded-[32px] sm:px-10 sm:py-20 lg:py-24">
        ...
        <div className="relative">
          <h2 className="mx-auto max-w-2xl text-3xl leading-tight tracking-tight text-white sm:text-4xl">
          ...
          <button
            type="button"
            onClick={openSignup}
            className="btn-glass-dark mt-8 inline-flex items-center justify-center rounded-xl px-8 py-4 text-base font-semibold"
          >
