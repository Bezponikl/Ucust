...
class SaigaLLMSkill:
    ...
    def _init_prompt(self):
        self.system_prompt = (
            ...
            "6. БЕЗ ДОДУМЫВАНИЙ И ВКУСОВЫХ ШТАМПОВ:\n"
            "   - Никогда не навязывай специфические жанры музыки (рок, рэп, поп), если клиент явно не указал их в анкете.\n"
            "   - Используй универсальные и мощные формулировки: 'мотивирующая музыка на всю громкость', 'заряжающий плейлист в наушниках', 'динамичный ритм'.\n\n"
