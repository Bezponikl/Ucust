  ...
  return (
    <div>
      ...
      <div ref={ref} className="relative">
        ...
        {open && (
          <div role="listbox" className="uc-pop-in absolute left-0 top-full z-50 mt-2 max-h-60 w-full overflow-auto rounded-2xl border border-white/10 bg-card/90 p-1.5 shadow-lift ring-1 ring-white/5 backdrop-blur-xl">
            {options.map((o) => (
              <button
                key={o}
                type="button"
