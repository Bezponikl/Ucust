...
def build_pdf():
    ...
    security_rules = [
        ...
        ("🎵 Правило «Zero-Assumptions» (Без додумывания вкусовых штампов):",
         "Запрет навязывания конкретных жанров музыки (рок, рэп) или вкусов, если они не указаны в анкете бренда. Используются универсальные эмоциональные формулировки (<i>«мотивирующая музыка на всю громкость», «заряжающий плейлист»</i>).")
    ]
    ...
    # 10. Раздел 3: Недостающие элементы и Дорожная карта (Roadmap)
