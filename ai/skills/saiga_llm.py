    ...
    def generate_smm_post(
        ...
        if "как понимает" in topic_lower or "что умеет" in topic_lower or "простыми словами" in topic_lower or "для простых" in topic_lower or "не айтиш" in topic_lower or "понимает запрос" in topic_lower:
            ...
            body = (
                ...
                f"🎬 <b>3. Смысловая режиссура кадра</b> — генератор фото подбирает ракурс, свет и эмоции, которые усиливают посыл текста и пробивают баннерную слепоту.\n"
            ...
            body = (
                ...
                f"🎬 <b>Визуальный сторителлинг и режиссура</b>\n"
                f"Генерация кинематографичных и UGC-кадров с выверенной композицией, драматургией света и живыми человеческими эмоциями.\n\n"
